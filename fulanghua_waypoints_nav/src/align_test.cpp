   ...
   public:
    AlignTest()
        ...
        robot_coordinate_sub = nh.subscribe(
            "robot_coordinate", 100, &AlignTest::coordinate_callback, this);
        odom_sub = nh.subscribe("odom", 100, &AlignTest::odom_callback, this);
        server.start();
    }
...
int main(int argc, char** argv) {
    ...
    AlignTest alignTest;
    ros::Time start_time;
    ros::Rate loop_rate(alignTest.hz);
